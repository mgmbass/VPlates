...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_A8AF1A76BFFA40229A198B4D0E3AB181
#define AU_COCOA_VIEW_NAME AUCocoaView_A8AF1A76BFFA40229A198B4D0E3AB181
...
const char* kAAXBundleID = "rackafxuser.aax.PlateVerb.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.PlateVerb.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.PlateVerb.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "Plate Verb";     // 31 chars max for AAX
const char* kShortPluginName = "Plate Verb";    // 15 chars max for AAX
const char* kAUBundleName = "Plate Verb";
...
const char* kVSTFUID = "{A8AF1A76-BFFA-4022-9A19-8B4D0E3AB181}"; /// NOTE: you need the enclosing { }
